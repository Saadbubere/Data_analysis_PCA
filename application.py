...
if uploaded_file is not None:
    ...
    scatter_column.plotly_chart(px.scatter(data_frame=pca_data, x=pca_1, y=pca_2, color=categorical_variable, template="simple_white", height=700, hover_data = [categorical_variable_2]), use_container_width=True)
